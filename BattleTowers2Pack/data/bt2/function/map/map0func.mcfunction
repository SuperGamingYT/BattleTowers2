...
execute positioned -44 319 -39 as @e[dx=100,dy=1,dz=200,team=Red_Team] run tp @s -2 239 13

#: Spawnpoints
spawnpoint @a[team=Red_Team] -2 239 13 270
...
execute as @a[team=Red_Team] at @s if block ~ ~ ~ minecraft:nether_portal run tp -2 239 13
execute as @a[nbt={Dimension:"minecraft:the_nether"},team=Blue_Team] run tp -2 239 110
execute as @a[nbt={Dimension:"minecraft:the_nether"},team=Red_Team] run tp -2 239 13
